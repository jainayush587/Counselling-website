...
<table align=center>
<?php
$sql1="SELECT * FROM coun3_msg where id=(select max(id) from coun3_msg)";
$record1=mysqli_query($conn,$sql1);
?>

<br><br>
<form name="message" method="post" action="a2.php">
<table align=center>

<tr>
<td>Enter message to be displayed to normal students:</td><td>:</td><td>
<textarea name="coun3msg11" id="coun3msg11">			
<?php
$sql1="SELECT * FROM coun3_msg where id=(select max(id) from coun3_msg)";
$record1=mysqli_query($conn,$sql1);
while($student=mysqli_fetch_assoc($record1))
		{
			echo "".$student['coun3msg11']."";
		}
?>
</textarea></td>
</tr>
...
<textarea name="coun3msg12" id="coun3msg12">
<?php
$sql1="SELECT * FROM coun3_msg where id=(select max(id) from coun3_msg)";
$record1=mysqli_query($conn,$sql1);
while($student=mysqli_fetch_assoc($record1))
		{
			echo "".$student['coun3msg12']."";
		}
?>
</textarea></td>
</tr>
...
<tr>
<td>Enter message to be displayed to students with moderate depression: </td><td>:</td><td><textarea name="coun3msg13" id="coun3msg13">
<?php
$sql1="SELECT * FROM coun3_msg where id=(select max(id) from coun3_msg)";
$record1=mysqli_query($conn,$sql1);
while($student=mysqli_fetch_assoc($record1))
		{
			echo "".$student['coun3msg13']."";
		}
?>
</textarea></td>
</tr>
...
<tr>
<td>Enter message to be displayed to students with severe depression: </td><td>:</td><td><textarea name="coun3msg14" id="coun3msg14">
<?php
$sql1="SELECT * FROM coun3_msg where id=(select max(id) from coun3_msg)";
$record1=mysqli_query($conn,$sql1);
while($student=mysqli_fetch_assoc($record1))
		{
			echo "".$student['coun3msg14']."";
		}
?>
</textarea></td>
</tr>
...
<tr>
<td>Enter message to be displayed to students with extremely severe depression: </td><td>:</td><td><textarea name="coun3msg15" id="coun3msg15">
<?php
$sql1="SELECT * FROM coun3_msg where id=(select max(id) from coun3_msg)";
$record1=mysqli_query($conn,$sql1);
while($student=mysqli_fetch_assoc($record1))
		{
			echo "".$student['coun3msg15']."";
		}
?>
</textarea></td>
</tr>
...
<tr>
<td>Enter message for students on special occassions </td><td>:</td><td><textarea name="coun3msg2" id="coun3msg2">
<?php
$sql1="SELECT * FROM coun3_msg where id=(select max(id) from coun3_msg)";
$record1=mysqli_query($conn,$sql1);
while($student=mysqli_fetch_assoc($record1))
		{
			echo "".$student['coun3msg2']."";
		}
?>
</textarea></td>
</tr>
...
<form action="upload.php" method="post" enctype="multipart/form-data">
  ...
  <center>
		<blockquote align="center">
						<h3><span style="color:white;"><strong><span">Test Results</span></strong></span></h3>
					</blockquote><br>
